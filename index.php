...
<html lang="en">
  ...
  <head>
    ...
    <title>
      <?php 
        ...
        if($page == "pengguna"){
          echo "Mj Keuangan - Pengguna";
        }else if($page == "keuangan"){
          echo "Mj Keuangan - Pribadi";
        }else if($page == "keuangananggota"){
          echo "Mj Keuangan - Anggota";
        }else if($page == "keuangananggotadetail"){
          echo "Mj Keuangan - Detail Keuangan Anggota";
        }else if($page == "laporankeuangan"){
          echo "Mj Keuangan - Laporan Keuangan";
        }else if($page == "info"){
          echo "Mj Keuangan - SiteMj Info";
        }else {
          echo "Mj Keuangan";
        }
      ?>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.php">Catat Keuangan</a>
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright © Seleksi Diginusa</span>
            </div>
          </div>
        </footer>
