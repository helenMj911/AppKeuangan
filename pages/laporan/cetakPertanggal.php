...
$mpdf->SetTitle('Laporan Keuangan');
    ...
    <body>
        <p class="header">
            <span class="judul">~ HelenMj ~</span><br /> 
            <span class="judul2">Laporan Keuangan</span>
        </p>
        <p class="body">
            &nbsp;&nbsp;&nbsp; Laporan Keuangan Anda, PerPeriode <b>Tanggal</b> Dalam menggunakan  aplikasi ini (<b>HelenMj</b>),Detail Nama Pengguna Dari Laporan Yang Akan Di Cetak : 
            <table>
                <tr>
                    <td>Nama</td>
                    <td>:</td>
        ...
        <br />
    <div class="footer">
        &nbsp;&nbsp;&nbsp; Terima Kasih sudah mempercayakan pengelolahan keuangan pribadi anda. Laporan Keuangan di atas akan akurat dengan data yang telaj dimasukan.
    </div>
    </body>
    </html>';
